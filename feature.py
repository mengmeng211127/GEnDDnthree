...
l.to_csv('./data2/data2_16feature_MFl.csv')
d = pd.DataFrame(feature_MFd)
d.index = association.columns.to_list()
d.to_csv('./data2/data2_16feature_MFd.csv')
...
l_emb.to_csv('./data2/data2_nonl_16feature.csv')
d_emb = pd.DataFrame(d_embeddings)
d_emb.index = association.columns.to_list()
d_emb.to_csv('./data2/data2_nond_16feature.csv')
...
lncrna.to_csv('./data2/rna_16feature.csv')
disease = pd.DataFrame(disease_feature)
disease.index = association.columns.to_list()
disease.to_csv('./data2/disease_16feature.csv')
